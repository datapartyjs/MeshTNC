...
CustomSX1281 radio_sx1281(new Module(P_SX1281_NSS, P_SX1281_DIO1, RADIOLIB_NC, -1, spi_sx1281));
...
static void select_radio(RadioLibWrapper* r) {
  ...
  digitalWrite(P_SX1281_RF_SW, HIGH);
}
...
bool radio_init() {
  ...
  select_radio(&radio_driver);  // default to 2.4GHz path during init

  //spi_sx1281.begin(P_SX1281_SCLK, P_SX1281_MISO, P_SX1281_MOSI);
